      ...
      <div className="flex justify-center py-8">
        <div className="bg-gray-100 p-6 rounded-lg shadow-md w-full max-w-md">
          <div className="flex items-center">
            <div className="flex items-center justify-center w-10 h-10 rounded-l-lg bg-white border-r border-gray-300">
              <svg
                viewBox="0 0 20 20"
                aria-hidden="true"
            ...
            <input
              ...
              className="w-full bg-white px-4 py-2 rounded-r-none outline-none text-gray-700 placeholder-gray-500 font-medium focus:ring-2 focus:ring-gray-300"
              placeholder="Search"
            />
            <button
              onClick={() => {
              ...
              className="bg-black text-white px-6 py-2 rounded-r-lg font-semibold transition-colors hover:bg-gray-800 focus:ring-2 focus:ring-gray-300"
            >
              Search
            </button>
          </div>
