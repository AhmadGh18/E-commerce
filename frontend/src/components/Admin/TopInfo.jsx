...
const TopInfo = () => {
  return (
    <div>
      <div className="flex items-center g-gray-100  ml-[250px]">
            ...
            <div className="bg-white shadow-sm rounded p-5">
              <div className="flex space-x-4 items-center">
                ...
                <div>
                  ...
                  <div className="text-2xl font-bold text-gray-900">lalak</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white shadow-sm rounded p-5">
              <div className="flex space-x-4 items-center">
                ...
                <div>
                  ...
                  <div className="text-2xl font-bold text-gray-900">lsl</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white shadow-sm rounded p-5">
              <div className="flex space-x-4 items-center">
                ...
                <div>
                  ...
                  <div className="text-2xl font-bold text-gray-900">ahaa</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white shadow-sm rounded p-5">
              <div className="flex space-x-4 items-center">
                ...
                <div>
                  ...
                  <div className="text-2xl font-bold text-gray-900">Ahmad</div>
                </div>
              </div>
            </div>
          </div>
